...
const initialRows = [
  createData(1, 'Tarefa 1', 'Café', '2022-01-01', '2022-01-02', 'Concluída', 'Recurso 1'),
  createData(2, 'Tarefa 2', 'Codar', '2022-01-03', '2022-01-04', 'Em Andamento', 'Recurso 2'),
  createData(3, 'Tarefa 3', 'Comer', '2022-01-04', '2022-01-05', 'Em Andamento', 'Recurso 3'),
  createData(4, 'Tarefa 4', 'Café', '2022-01-05', '2022-01-06', 'Em Andamento', 'Recurso 4'),
  createData(5, 'Tarefa 5', 'Codar', '2022-01-06', '2022-01-07', 'Em Andamento', 'Recurso 5'),
  createData(6, 'Tarefa 6', 'Dormir', '2022-01-07', '2022-01-08', 'Aguardando', 'Recurso 6'),
];
...
const ListarTarefa = () => {
  ...
  const handleDeletar = (id) => {
    ...
    return(
    <>
    <img src="https://yt3.googleusercontent.com/5TjlI6nK7bU8ZORSy8q7ODI0pcdcvN7Vn7-lqnhO-AlscJgTL0GGyVtNdvFCvMIv5wKfeMdRyQ=s900-c-k-c0x00ffffff-no-rj" 
      alt="Image"
      height={62}
      width={62}
    />
    ...
    <Card>
        <CardHeader
          title="Tarefas de um programador:"
          subheader="Listagem de Tarefas Incríveis!"
        /> 
        <CardContent>
